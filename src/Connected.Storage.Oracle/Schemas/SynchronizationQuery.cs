...
/// <summary>
/// Base class for Oracle schema synchronization query operations that retrieve data.
/// </summary>
...
/// schema query operations. Oracle-specific queries leverage system views like ALL_TABLES,
/// ALL_TAB_COLUMNS, ALL_CONSTRAINTS, and ALL_INDEXES for metadata retrieval.
/// </remarks>
	...
	: SynchronizationCommand
{
	...
	/// implementation to perform the actual query operation and retrieve results. The context
	/// provides access to the Oracle connection, schema metadata, and constraint registries.
	/// </remarks>
	...
	/// from Oracle system catalogs like ALL_TABLES, ALL_TAB_COLUMNS, ALL_CONSTRAINTS,
	/// ALL_INDEXES, and ALL_SEQUENCES.
	/// </remarks>
