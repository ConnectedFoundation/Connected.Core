...
/// <summary>
/// Middleware for synchronizing PostgreSQL database schemas with entity definitions.
/// </summary>
/// <remarks>
/// This middleware handles schema synchronization for PostgreSQL databases including support for
...
/// PostgreSQL-specific syntax and system catalog queries are used throughout the implementation
/// to ensure compatibility with PostgreSQL database features.
/// </remarks>
[Priority(0)]
internal sealed class PostgreSqlSchemaMiddleware(IMiddlewareService middleware, IStorageProvider storage, IConfigurationService configuration)
