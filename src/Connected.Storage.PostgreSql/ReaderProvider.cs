...
/// <summary>
/// Provides PostgreSQL database reader instances for query operations.
/// </summary>
/// <remarks>
/// This sealed class implements <see cref="StorageReaderProvider"/> to create reader instances
/// for executing SELECT queries against PostgreSQL databases. It creates <see cref="DatabaseReader{TEntity}"/>
...
/// queries (Query) with proper connection lifecycle management.
/// </remarks>
[Priority(0)]
	...
	: StorageReaderProvider
{
	...
	/// materializing results, and managing connection lifecycle based on the connection mode.
	/// For isolated connections, the reader commits transactions and closes connections after
	/// query execution.
	/// </remarks>
