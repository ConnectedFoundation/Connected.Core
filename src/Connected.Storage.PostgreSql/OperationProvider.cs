...
using Connected.Storage.PostgreSql.Transactions;

namespace Connected.Storage.PostgreSql;

/// <summary>
/// Provides PostgreSQL storage operations for entity state management.
/// </summary>
/// <remarks>
/// This sealed class implements <see cref="StorageOperationProvider"/> to generate DML commands
/// (INSERT, UPDATE, DELETE) for entity operations against PostgreSQL databases. It uses the
...
/// other providers in the middleware pipeline. Generated commands use PostgreSQL-specific syntax
/// including double-quoted identifiers and RETURNING clauses for identity columns.
/// </remarks>
[Priority(0)]
